...
#define NON_EXISTED_FILENAME "..!5!u!S!" // used to re-test the dcache lookup, make sure you don't have file named like this!!
const struct qstr susfs_fake_qstr_name = QSTR_INIT(NON_EXISTED_FILENAME, strlen(NON_EXISTED_FILENAME));
